...
<div class="w3-sidebar w3-bar-block " style="margin: 0 0 5% 0;">
  <div class="sidebar-module" style="font-family: Arial Black, Gadget, sans-serif;">
    <!-- <div class="col">
      <a href="{{ route('customers.create') }}" class="btn btn-sm btn-primary btn-create">
...
<div class="container box">
  <h3 align="center">My Withdrawers</h3><br />
  <div class="panel panel-default">
    <div class="panel-heading">Search Withdrawer Data</div>
